...
public class QuizManager : MonoBehaviour {
    ...
    void Start()
    {
        ...
        events.StartupHighscore = PlayerPrefs.GetInt(QuizUtility.SavePrefKey);
    ...
    public void Accept()
    {
        ...
        UpdateScore((isCorrect) ? Questions[currentQuestion].AddScore : Questions[currentQuestion].WrongScore);
    ...
    {
        yield return new WaitForSeconds(QuizUtility.ResolutionDelayTime);
        Display();
    }
    ...
    void LoadQuestions()
    {
        Object[] objs = Resources.LoadAll("Secondary", typeof(Question));
    ...
    /// </summary>
    public void QuitQuiz(string sceneName)
    {
        SceneManager.LoadScene(sceneName);
        AudioManager.Instance.StopSound("QuizMusic");
    }
    ...
    {
        var highscore = PlayerPrefs.GetInt(QuizUtility.SavePrefKey);
        if (highscore < events.CurrentFinalScore)
        {
            PlayerPrefs.SetInt(QuizUtility.SavePrefKey, events.CurrentFinalScore);
        }
    }
    /// <summary>
